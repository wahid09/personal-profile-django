...
from Blog_App.views import index, getauthor, getsingle, categoryPost, CreateBlog, MyPost, article_detail_view
...
urlpatterns = [
    ...
    path('article-detail/<slug:slug>', article_detail_view, name="blog_details")
]
